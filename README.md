...
整體開發總結見 [`PM_Guide/README_OVERNIGHT_SUMMARY.md`](PM_Guide/README_OVERNIGHT_SUMMARY.md)。
...
- `PM_Guide/` — 每個功能的決策文件（問題 / 方案取捨 / 實作 / 測試）

## 設計系統

海洋色票與動畫架構見 [`PM_Guide/claude_pro_ocean_theme.md`](PM_Guide/claude_pro_ocean_theme.md)，
Token 收斂見 [`PM_Guide/03_design_tokens.md`](PM_Guide/03_design_tokens.md)。
